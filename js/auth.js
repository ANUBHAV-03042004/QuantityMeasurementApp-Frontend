...
async function doLogin() {
  ...
  // Login fetch — change:
const res = await fetch('http://quantra.us-east-1.elasticbeanstalk.com/api/v1/auth/login', {
      method: 'POST',
...
async function doRegister() {
  ...
  try {
  const res = await fetch('http://quantra.us-east-1.elasticbeanstalk.com/api/v1/auth/register', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
